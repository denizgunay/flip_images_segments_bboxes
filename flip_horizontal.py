...
def flip_horizontal(old_jsonpath = 'sag_sol_train_and_val-19_1.json', updated_jsonpath = 'UPDATED_data.json', image_folder = 'datasets/sag_sol_train_and_val/', json_spec = True):
    ...
    """
    flip_horizontal() is the main function and it adds 'FH_' to the image name after flipping all unflipped images in the dataset horizontally.
    ...
    annotations = annotator(annotation_list,orig_image_list,img_id_conv,flip_img_id_conv)
